...
def login_post():
    ...
    if check_password(plain, pwd_hash):
        ...
        # Store plaintext password as encryption key for sensitive variables.
        # Flask signs the session cookie, so this is safe for a local tool.
        session["tgm_enc_key"] = plain
